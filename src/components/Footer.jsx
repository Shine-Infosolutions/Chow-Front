...
const MAPS_URL =
  "https://maps.google.com/?q=Chowdhry+Sweet+House+Vijay+Chowk+Gorakhpur";
      ...
      <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 sm:py-14">
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4 lg:gap-10">
          ...
          <div>
            ...
            <p className="max-w-xs text-sm leading-relaxed text-gray-600">
              Handcrafted traditional mithai &amp; namkeen from the heart of
              Gorakhpur — serving sweetness since 1970.
            </p>
            <a
          ...
          {/* Shop */}
          <div>
            <h4 className="font-display mb-4 text-lg font-semibold text-gray-900">
              Shop
            </h4>
            <ul className="space-y-2.5 text-sm">
              <li>
                <Link
                  to="/"
                  className="text-gray-600 transition-colors hover:text-[#d80a4e]"
                >
                  Home
                </Link>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-600">
              <li className="flex items-start gap-2">
                ...
                <span>
                  Vijay Chowk, in front of Vijay Talkies, Golghar, Gorakhpur, UP
                  273001
                </span>
              </li>
              <li className="flex items-start gap-2">
        ...
        <div className="mt-10 flex flex-col items-center justify-between gap-3 border-t border-amber-100 pt-6 text-sm sm:flex-row">
          <p className="text-center text-gray-500 sm:text-left">
            ...
            <strong className="text-gray-700">Chowdhry Sweet House</strong>. All
            rights reserved.
          </p>

          <p className="flex items-center gap-1.5 font-medium text-green-600">
            🛵 Free delivery within 5 km in Gorakhpur
          </p>
          ...
          <p className="text-center text-gray-400 sm:text-right">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="font-medium text-[#d80a4e] hover:underline"
            >
              Shine Infosolutions
            </a>
          </p>
